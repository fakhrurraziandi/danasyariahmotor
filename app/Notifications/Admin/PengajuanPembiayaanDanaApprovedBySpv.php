...
class PengajuanPembiayaanDanaApprovedBySpv extends Notification
{
    ...
    {
        return [
            'message' => 'Pengajuan Pembiayaan Dana '. $this->pengajuan_pembiayaan_dana->user->name . ' telah di setujui oleh SPV',
            'url' => route('admin.pengajuan_pembiayaan_dana.show', $this->pengajuan_pembiayaan_dana->id),
            'data' => [
