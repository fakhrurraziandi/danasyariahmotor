...
class PengajuanKreditMotorDeniedByCs extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        //             'Pengajuan Kredit '. $this->pengajuan_kredit_motor->user->name . ' telah di tolak oleh CS',
        //             $admin->userId,
        ...
        return [
            'message' => 'Pengajuan Kredit '. $this->pengajuan_kredit_motor->user->name . ' telah di tolak oleh CS',
            'url' => route('admin.pengajuan_kredit_motor.show', $this->pengajuan_kredit_motor->id),
            'data' => [
