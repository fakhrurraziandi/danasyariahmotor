...
class PengajuanKreditMotorApprovedBySpv extends Notification
{
    use Queueable;
...
Surya Motor ",
            ...
            'onesignal_message' =>   'Pengajuan Kredit Motor dari '. $this->pengajuan_kredit_motor->user->name . ' telah di setujui oleh SPV anda',
            'message'           =>   'Pengajuan Kredit Motor dari '. $this->pengajuan_kredit_motor->user->name . ' telah di setujui oleh SPV anda',
            'url'               => route('cs_kredit_motor.pengajuan_kredit_motor', $this->pengajuan_kredit_motor),
        ];
    }
