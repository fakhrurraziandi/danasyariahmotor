...
class PengajuanKreditMotorDenied extends Notification
{
    use Queueable;
    ...
    public function __construct(PengajuanKreditMotor $pengajuan_kredit_motor)
    {
        ...
        $this->notification_data = [
            'whatsapp_message'  =>   'Pengajuan kredit motor anda telah di tolak', 
            'onesignal_message' =>   'Pengajuan kredit motor anda telah di tolak', 
            'message'           =>   'Pengajuan kredit motor anda telah di tolak', 
            'url'               => route('pengajuan_kredit_motor.show', $this->pengajuan_kredit_motor->id), 
        ];
    }
