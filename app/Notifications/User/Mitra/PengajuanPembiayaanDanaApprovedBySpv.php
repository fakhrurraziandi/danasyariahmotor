...
class PengajuanPembiayaanDanaApprovedBySpv extends Notification
{
    ...
    public function __construct(PengajuanPembiayaanDana $pengajuan_pembiayaan_dana)
    {
        ...
        $this->notification_data = [
            'whatsapp_message'  => "Pengajuan Pembiayaan Dana Kustomer Mitra Atas Nama : {$this->pengajuan_pembiayaan_dana->user->name} telah di setujui oleh CABANG DSM",
            'onesignal_message' => "Pengajuan Pembiayaan Dana dari {$this->pengajuan_pembiayaan_dana->user->name} telah di setujui oleh SPV",
            'message'           => "Pengajuan Pembiayaan Dana dari {$this->pengajuan_pembiayaan_dana->user->name} telah di setujui oleh SPV",
