...
class PengajuanPembiayaanDanaDeniedBySpv extends Notification
{
    ...
    public function __construct(PengajuanPembiayaanDana $pengajuan_pembiayaan_dana)
    {
        ...
        $this->notification_data = [
            'whatsapp_message'  => "Pengajuan Pembiayaan Dana dari {$this->pengajuan_pembiayaan_dana->user->name} telah di tolak oleh SPV",
            'onesignal_message' => "Pengajuan Pembiayaan Dana dari {$this->pengajuan_pembiayaan_dana->user->name} telah di tolak oleh SPV",
            'message'           => "Pengajuan Pembiayaan Dana dari {$this->pengajuan_pembiayaan_dana->user->name} telah di tolak oleh SPV",
