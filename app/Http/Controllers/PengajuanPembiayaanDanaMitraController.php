...
class PengajuanPembiayaanDanaMitraController extends Controller
{
    ...
    public function json(Request $request)
    {
        ...
        $pengajuan_pembiayaan_dana = PengajuanPembiayaanDana::with([
            ...
            ['cs_pembiayaan_dana_status', '=', null],
            ['spv_pembiayaan_dana_status', '=', null],
        ])->search($search);
    ...
    public function json_approved(Request $request)
    {
        $limit = $request->filled('limit') ? $request->get('limit') : 10;
        $offset = $request->filled('offset') ? $request->get('offset') : 0;
        $search = $request->filled('search') ? $request->get('search') : '';
        ...
        $pengajuan_pembiayaan_dana = PengajuanPembiayaanDana::with([
            ...
            ['mitra_id', '=', auth()->user()->id],
            ['cs_pembiayaan_dana_status', '=', 'approved'],
            ['spv_pembiayaan_dana_status', '=', 'approved'],
        ])->search($search);
        $data['total'] = $pengajuan_pembiayaan_dana->count();
    ...
    {
        return view('pengajuan_pembiayaan_dana_mitra.index');
    }
    ...
    {
        // return get_class($pengajuan_pembiayaan_dana);
        // return $pengajuan_pembiayaan_dana;
        return view('pengajuan_pembiayaan_dana_mitra.show', compact('pengajuan_pembiayaan_dana'));
    }
