            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('backend.type_motor.store')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/type_motor/create.blade.php */ ?>