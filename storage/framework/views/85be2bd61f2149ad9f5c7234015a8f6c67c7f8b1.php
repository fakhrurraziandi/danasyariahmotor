            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('backend.permission.store')); ?>" method="POST">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/permission/create.blade.php */ ?>