            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('backend.angsuran_motor.update', $angsuran_motor->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" class="form-control <?php echo e($errors->has('dp') ? 'is-invalid' : ''); ?>" name="dp" id="dp" value="<?php echo e(old('dp', $angsuran_motor->dp)); ?>">
                            ...
                            <?php $__currentLoopData = $list_tempo_angsuran_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tempo_angsuran_motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control <?php echo e($errors->has('tempo_angsuran_motor_id') ? 'is-invalid' : ''); ?>" name="tempo_angsuran_motor_id[<?php echo e($tempo_angsuran_motor->id); ?>]" id="tempo_angsuran_motor_id" value="<?php echo e(old('tempo_angsuran_motor_id['. $tempo_angsuran_motor->id .']', $angsuran_motor->angsuran_motor_detail->where('tempo_angsuran_motor_id', $tempo_angsuran_motor->id)->first()->angsuran_per_bulan)); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 offset-sm-2">
                                    ...
                                    <a href="<?php echo e(route('backend.angsuran_motor.index', $angsuran_motor->motor->id)); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/angsuran_motor/edit.blade.php */ ?>