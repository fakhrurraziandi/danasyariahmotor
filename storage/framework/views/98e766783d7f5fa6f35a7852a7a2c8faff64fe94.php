                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control <?php echo e($errors->has('alamat') ? 'is-invalid' : ''); ?>" id="alamat" name="alamat" placeholder="Alamat" ><?php echo e(old('alamat')); ?></textarea>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/user/create.blade.php */ ?>