                    ...
                    <div class="col-md-4">
                        ...
                        <div class="text-center">
                            <h6 class="mb-4 mt-4"> 
                                ...
                                <?php echo e(auth()->guard('cs_kredit_motor')->user()->notifications->count()); ?> Notifications
                            </h6>
                            <p><a href="<?php echo e(route('cs_kredit_motor.notifications')); ?>" class="btn btn-primary">Lihat Notifikasi</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item mr-2">
                        <a class="nav-link active" href="<?php echo e(route('cs_kredit_motor.list_pengajuan_kredit_motor')); ?>">Pengajuan Kredit Motor</a>
                    </li>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/cs_kredit_motor/main.blade.php */ ?>