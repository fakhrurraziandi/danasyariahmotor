            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.spesifikasi_motor.update', $spesifikasi_motor->id)); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control <?php echo e($errors->has('kategori_spesifikasi_id') ? 'is-invalid' : ''); ?>" name="kategori_spesifikasi_id" id="kategori_spesifikasi_id">
                                        ...
                                        <?php $__currentLoopData = $list_kategori_spesifikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori_spesifikasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e(old('kategori_spesifikasi_id', $spesifikasi_motor->kategori_spesifikasi_id) == $kategori_spesifikasi->id ? 'selected=""' : ''); ?> value="<?php echo e($kategori_spesifikasi->id); ?>"><?php echo e($kategori_spesifikasi->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" type="text" name="name" id="name" value="<?php echo e(old('name', $spesifikasi_motor->name)); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control <?php echo e($errors->has('value') ? 'is-invalid' : ''); ?>" type="text" name="value" id="value" value="<?php echo e(old('value', $spesifikasi_motor->value)); ?>">
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/admin/spesifikasi_motor/edit.blade.php */ ?>