<?php $__env->startSection('sub_content'); ?>
    ...
    <form action="<?php echo e(route('spv_kredit_motor.update_password', [$spv_kredit_motor->id])); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-9 offset-sm-3">
                <a href="<?php echo e(route('spv_kredit_motor.index')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/spv_kredit_motor/change_password.blade.php */ ?>