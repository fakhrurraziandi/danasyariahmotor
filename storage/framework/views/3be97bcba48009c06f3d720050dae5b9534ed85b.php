                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.testimoni_motor.store', $motor->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" type="text" clas="form-control" name="name" id="name">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control <?php echo e($errors->has('message') ? 'is-invalid' : ''); ?>" name="message" id="message" cols="30" rows="10"></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate1" name="rate" class="custom-control-input" value="1" checked="">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/admin/testimoni_motor/create.blade.php */ ?>