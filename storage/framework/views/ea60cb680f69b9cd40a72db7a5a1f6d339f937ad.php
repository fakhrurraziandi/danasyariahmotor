                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="table-data-toolbar">
                            ...
                            <a href="<?php echo e(route('backend.angsuran_motor.create', $motor->id)); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
                        </div>
    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '<?php echo e(route('backend.angsuran_motor.json', $motor->id)); ?>',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
                        ...
                        formatter: function(value, row, index){
                            return `
                                <a class="btn btn-sm btn-info" href="${base_url + '/backend/angsuran_motor/' + value + '/edit'}"><i class="fa fa-edit"></i> Edit</a>
                                <form method="POST" action="${base_url + '/backend/angsuran_motor/' + value}" class="d-inline" onsubmit="return confirm('Are you sure you want to  delete   data ${row.dp}?')">
                    ...
                    <?php $__currentLoopData = $list_tempo_angsuran_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tempo_angsuran_motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        {
                            field: '<?php echo e($tempo_angsuran_motor->tempo); ?>',
                            title: '<?php echo e($tempo_angsuran_motor->tempo); ?> bulan',
                            formatter: function(value, row, index){
                                if(value){
                                    return 'Rp. '+ value;
                                }
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/angsuran_motor/index.blade.php */ ?>