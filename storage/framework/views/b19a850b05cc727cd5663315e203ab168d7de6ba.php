                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo e(route('submit-pengajuan-online')); ?>" method="POST">
                                            ...
                                            <?php if($motor->angsuran_motor()->count() > 0): ?>
                                                ...
                                                <div class="row">
	                                                <div class="col-md-12">
	                                                    <h4 class="h5 text-center mb-20"><small>OTR </small>Rp. <?php echo e(number_format($motor->harga,0,",",".")); ?></h4>
	                                                </div>
	                                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card border-0 mb-3" style="background-color: #eee;">
                            <div class="card-body text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-3">CC: <?php echo e($motor->kapasitas_mesin ? $motor->kapasitas_mesin->cc : '-'); ?></div>
                                    <div class="col-md-3">Pembakaran: <?php echo e($motor->jenis_pembakaran ? $motor->jenis_pembakaran->name : '-'); ?></div>
                                    <div class="col-md-3">Transmisi: <?php echo e($motor->jenis_transmisi ? $motor->jenis_transmisi->name : '-'); ?></div>
                                    <div class="col-md-3">Type: <?php echo e($motor->type_motor ? $motor->type_motor->name : '-'); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="fitur-tab" data-toggle="tab" href="#fitur" role="tab" aria-controls="fitur" aria-selected="true">Fitur</a>
                            </li>
                            ...
                            <?php $__currentLoopData = $list_kategori_spesifikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori_spesifikasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                    <a class="nav-link " id="<?php echo e(str_slug($kategori_spesifikasi->name)); ?>-tab" data-toggle="tab" href="#<?php echo e(str_slug($kategori_spesifikasi->name)); ?>" role="tab" aria-controls="<?php echo e($kategori_spesifikasi->name); ?>" aria-selected="true"><?php echo e($kategori_spesifikasi->name); ?></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="py-3 px-2 tab-pane fade show active " id="fitur" role="tabpanel" aria-labelledby="fitur-tab">
                                <?php echo $motor->fitur; ?>

                            </div>
                            <?php $__currentLoopData = $list_kategori_spesifikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori_spesifikasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="py-3 px-2 tab-pane fade " id="<?php echo e(str_slug($kategori_spesifikasi->name)); ?>" role="tabpanel" aria-labelledby="<?php echo e(str_slug($kategori_spesifikasi->name)); ?>-tab">
                                    <?php  
                                    ...
                                    <?php if($list_spesifikasi_motor->count() > 0): ?>

                                        <table class="table table-striped">
                                            <?php $__currentLoopData = $list_spesifikasi_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spesifikai_motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="text-left font-weight-bold"><?php echo e($spesifikai_motor->name); ?></td>
                                                <td class="text-left" style="width: 10px;">:</td>
                                                <td class="text-left"><?php echo e($spesifikai_motor->value); ?></td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </table>
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/detail-motor.blade.php */ ?>