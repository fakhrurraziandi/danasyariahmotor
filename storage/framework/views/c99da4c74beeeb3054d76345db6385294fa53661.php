                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8"><?php echo e($pengajuan_kredit_motor->wilayah_kredit_motor->name); ?></dd>
                ...
                <div class="col-md-12 text-center">
                    <div class="py-4">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="cs_kredit_motor_status1" name="cs_kredit_motor_status" class="custom-control-input" value="denied">
                            <label class="custom-control-label" for="cs_kredit_motor_status1">Tolak</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="cs_kredit_motor_status2" name="cs_kredit_motor_status" class="custom-control-input" value="approved">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/cs_kredit_motor/pengajuan_kredit_motor.blade.php */ ?>