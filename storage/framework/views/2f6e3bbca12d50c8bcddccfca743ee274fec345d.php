    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient--lush sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.jenis_pembakaran.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.kategori_spesifikasi.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/layouts/admin.blade.php */ ?>