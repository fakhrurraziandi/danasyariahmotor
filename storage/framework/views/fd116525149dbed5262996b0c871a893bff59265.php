            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('backend.tempo_angsuran_motor.store')); ?>" method="POST">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/tempo_angsuran_motor/create.blade.php */ ?>