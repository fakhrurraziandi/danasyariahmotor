            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-md-6 mb-4 text-center">
                    ...
                    <p>
                        ...
                        <a class="btn btn-primary" href="<?php echo e(route('pengajuan_pembiayaan_dana.index')); ?>">Lihat Pengajuan Anda</a> 
                    </p>
                </div>
            </div>
        </div>
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/akad-kredit-success.blade.php */ ?>