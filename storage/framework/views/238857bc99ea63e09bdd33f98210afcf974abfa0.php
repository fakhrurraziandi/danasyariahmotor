<?php $__env->startSection('sub_content'); ?>
    ...
    <form action="<?php echo e(route('cs_pembiayaan_dana.update_password', [$cs_pembiayaan_dana->id])); ?>" method="POST" enctype="multipart/form-data">
...
<?php /* /home/danasyariahmotor/public_html/resources/views/cs_pembiayaan_dana/change_password.blade.php */ ?>