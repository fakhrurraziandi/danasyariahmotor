						...
						<div class="col-md-4 mb-3">
							<div class="card border-0 shadow-sm d-flex justify-content-between" style="height: 100%;">
								...
								<div class="card-body d-flex flex-column justify-content-end">
									...
									<?php $angsuran_motor = $motor->angsuran_motor()->orderBy('dp', 'ASC')->take(2)->get() ?>

									<?php if($angsuran_motor->count() > 0): ?>
										<?php if($angsuran_motor->count() == 1): ?>
											<h5 class="font-weight-bold text-primary">Rp. <?php echo e($angsuran_motor[0]->dp); ?></h5>
										<?php endif; ?>

										<?php if($angsuran_motor->count() == 2): ?>
											<h5 class="font-weight-bold text-primary">Rp. <?php echo e($angsuran_motor[0]->dp); ?></h5>
											<h6 class="text-secondary"><strike>Rp. <?php echo e($angsuran_motor[1]->dp); ?></strike></h6>
										<?php endif; ?>										
									<?php else: ?>
...
<?php /* C:\xampp\htdocs\dsm\resources\views/beli-motor.blade.php */ ?>