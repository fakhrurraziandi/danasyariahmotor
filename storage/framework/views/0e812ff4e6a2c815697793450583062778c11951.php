            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.pabrikan_motor.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo e(route('admin.pabrikan_motor.index')); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
                        </form>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/pabrikan_motor/create.blade.php */ ?>