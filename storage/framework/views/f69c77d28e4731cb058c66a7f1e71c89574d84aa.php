            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('backend.motor.update', $motor->id)); ?>" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control <?php echo e($errors->has('harga') ? 'is-invalid' : ''); ?>" name="harga" id="harga" value="<?php echo e(old('harga', $motor->harga)); ?>">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/motor/edit.blade.php */ ?>