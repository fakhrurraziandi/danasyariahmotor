            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.photo_motor.store', $motor->id)); ?>" method="POST" enctype="multipart/form-data">
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/photo_motor/create.blade.php */ ?>