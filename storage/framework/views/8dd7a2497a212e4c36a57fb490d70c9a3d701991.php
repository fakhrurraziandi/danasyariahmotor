                ...
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="tempo_angsuran_pembiayaan_id_disetujui" class="col-sm-3 col-form-label">Tempo angsuran yang disetujui</label>
                                <div class="col-sm-9">
                                    <select name="tempo_angsuran_pembiayaan_id_disetujui" id="tempo_angsuran_pembiayaan_id_disetujui" class="form-control <?php echo e($errors->has('tempo_angsuran_pembiayaan_id_disetujui') ? 'is-invalid' : ''); ?>">
                                        <?php $__currentLoopData = App\TempoAngsuranPembiayaanDana::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tempo_angsuran_pembiayaan_dana): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e(old('tempo_angsuran_pembiayaan_id_disetujui', $pengajuan_pembiayaan_dana->tempo_angsuran_pembiayaan_dana->id) ==  $tempo_angsuran_pembiayaan_dana->id ? 'selected=""' : ""); ?> value="<?php echo e($tempo_angsuran_pembiayaan_dana->id); ?>"><?php echo e($tempo_angsuran_pembiayaan_dana->tempo . ' bulan'); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($errors->has('tempo_angsuran_pembiayaan_id_disetujui')): ?>
                                        <div class="invalid-feedback">
                                            <?php echo e($errors->first('tempo_angsuran_pembiayaan_id_disetujui')); ?>
                ...
                <div class="col-md-12 text-center">
                    <div class="py-4">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="cs_pembiayaan_dana_status1" name="cs_pembiayaan_dana_status" class="custom-control-input" value="denied">
                            <label class="custom-control-label" for="cs_pembiayaan_dana_status1">Tolak</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="cs_pembiayaan_dana_status2" name="cs_pembiayaan_dana_status" class="custom-control-input" value="approved">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/cs_pembiayaan_dana/pengajuan_pembiayaan_dana.blade.php */ ?>