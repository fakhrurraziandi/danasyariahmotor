								...
								<div class="card-body d-flex flex-column justify-content-end">
									...
									<?php if($angsuran_motor): ?>
										...
										<?php if($motor->has_discount_dp): ?>
											<h5 class="font-weight-bold text-primary">Rp. <?php echo e($angsuran_motor->dp_calculated); ?></h5>
											<h6 class="text-secondary"><strike>Rp. <?php echo e($angsuran_motor->dp); ?></strike></h6>
										<?php else: ?>
											<h5 class="font-weight-bold text-primary">Rp. <?php echo e($angsuran_motor->dp); ?></h5>
										<?php endif; ?>
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/beli-motor.blade.php */ ?>