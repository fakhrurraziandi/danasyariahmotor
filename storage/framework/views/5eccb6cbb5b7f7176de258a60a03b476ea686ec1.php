    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">Change <?php echo e($user->name); ?> password</div>
                    <div class="card-body">

                        <form action="<?php echo e(route('admin.user.update_password', $user->id)); ?>" method="POST">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/admin/user/change_password.blade.php */ ?>