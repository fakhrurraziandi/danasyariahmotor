            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.jenis_pembakaran.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo e(route('admin.jenis_pembakaran.index')); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
                        </form>
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/admin/jenis_pembakaran/create.blade.php */ ?>