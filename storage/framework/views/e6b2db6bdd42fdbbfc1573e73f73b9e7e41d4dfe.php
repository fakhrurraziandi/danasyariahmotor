            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.spv_pembiayaan_dana.store')); ?>" method="POST">
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/spv_pembiayaan_dana/create.blade.php */ ?>