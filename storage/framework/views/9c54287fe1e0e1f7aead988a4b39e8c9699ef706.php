    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient--lush sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.permission.index')); ?>">
                        <i class="fas fa-fw fa-list"></i>
                        <span>Permissions</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.role.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.pabrikan_motor.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.type_motor.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.warna_motor.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.kapasitas_mesin.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.jenis_transmisi.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.wilayah.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                        <span>Wilayah</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.tempo_angsuran_motor.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('backend.motor.index')); ?>">
                        <i class="fas fa-fw fa-circle"></i>
                        <span>Motor</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Sample Dropdown:</h6>
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/layouts/backend.blade.php */ ?>