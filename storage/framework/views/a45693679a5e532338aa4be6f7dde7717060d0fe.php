        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <img data-src="<?php echo e(asset('dsm_design/dist/img/meetin-up-office-2@2x-hijab.png')); ?>" class="lazy img-fluid" alt="">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h1 class="text-center font-weight-light mb-50">MENGAPA DANA SYARIAH MOTOR?</h1>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/tentang-kami.blade.php */ ?>