    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '<?php echo e(route('spv_pembiayaan_dana.json_pengajuan_pembiayaan_dana')); ?>',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
                        ...
                        formatter: function(value, row, index){
                            return `
                                <a class="btn btn-sm btn-info" href="${base_url + '/spv_pembiayaan_dana/pengajuan_pembiayaan_dana/' + value }">Detail</a>
                            `;
                        }
                    },
                    {
...
<?php /* /home/danasyariahmotor/public_html/resources/views/spv_pembiayaan_dana/list_pengajuan_pembiayaan_dana.blade.php */ ?>