                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.angsuran_motor.update', $angsuran_motor->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" max="100" min="0" class="form-control <?php echo e($errors->has('discount_dp') ? 'is-invalid' : ''); ?>" name="discount_dp" id="discount_dp" value="<?php echo e(old('discount_dp', $angsuran_motor->discount_dp)); ?>">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/admin/angsuran_motor/edit.blade.php */ ?>