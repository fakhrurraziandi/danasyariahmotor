            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('backend.pabrikanmotor.store')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/pabrikanmotor/create.blade.php */ ?>