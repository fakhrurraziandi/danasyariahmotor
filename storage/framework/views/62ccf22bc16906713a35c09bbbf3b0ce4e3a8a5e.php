            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.cs_kredit_motor.store')); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?php echo e($errors->has('spv_kredit_motor_id') ? 'is-invalid' : ''); ?>" id="spv_kredit_motor_id" name="spv_kredit_motor_id" placeholder="SPV Kredit Motor">
                                            ...
                                            <?php $__currentLoopData = $list_spv_kredit_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wilayah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('spv_kredit_motor_id') == $wilayah->id ? 'selected=""' : ''); ?> value="<?php echo e($wilayah->id); ?>"><?php echo e($wilayah->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/admin/cs_kredit_motor/create.blade.php */ ?>