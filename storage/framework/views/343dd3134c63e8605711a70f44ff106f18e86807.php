    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">Add new jenis transmisi</div>
                    <div class="card-body">

                        <form action="<?php echo e(route('backend.jenis_transmisi.store')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/jenis_transmisi/create.blade.php */ ?>