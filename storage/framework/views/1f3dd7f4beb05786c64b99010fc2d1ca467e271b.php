<?php $__env->startSection('sub_content'); ?>
    ...
    <form action="<?php echo e(route('cs_kredit_motor.process_pengajuan_kredit_motor', $pengajuan_kredit_motor->id)); ?>" method="POST">
        ...
        <div class="row">
            ...
            <?php if(!$pengajuan_kredit_motor->cs_kredit_motor_status): ?>

                <div class="col-md-12 text-center">
                    <div class="py-4">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="cs_kredit_motor_status1" name="cs_kredit_motor_status" class="custom-control-input cs_kredit_motor_status" value="denied" <?php echo e(old('cs_kredit_motor_status', $pengajuan_kredit_motor->cs_kredit_motor_status) == 'denied' ? 'checked=""' : ''); ?>>
                            <label class="custom-control-label" for="cs_kredit_motor_status1">Tolak</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="cs_kredit_motor_status2" name="cs_kredit_motor_status" class="custom-control-input cs_kredit_motor_status" value="approved" <?php echo e(old('cs_kredit_motor_status', $pengajuan_kredit_motor->cs_kredit_motor_status) == 'approved' ? 'checked=""' : ''); ?>>
                            <label class="custom-control-label" for="cs_kredit_motor_status2">Setujui</label>
                        </div>
                    </div>

                    <?php if($errors->has('cs_kredit_motor_status')): ?>
                        <div class="pb-4 text-center text-danger">
                            <?php echo e($errors->first('cs_kredit_motor_status')); ?>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control <?php echo e($errors->has('cs_kredit_motor_note') ? 'is-invalid' : ''); ?>" id="cs_kredit_motor_note" name="cs_kredit_motor_note" value="<?php echo e(old('cs_kredit_motor_note')); ?>" rows="5"></textarea>
                                    <?php if($errors->has('cs_kredit_motor_note')): ?>
                                        <div class="invalid-feedback">
                                            <?php echo e($errors->first('cs_kredit_motor_note')); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="spv_kredit_motor_id" id="spv_kredit_motor_id" class="form-control <?php echo e($errors->has('spv_kredit_motor_id') ? 'is-invalid' : ''); ?>">
                                        <option></option>
                                        <?php $__currentLoopData = $pengajuan_kredit_motor->wilayah_kredit_motor->spv_kredit_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spv_kredit_motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e(old('spv_kredit_motor_id', $pengajuan_kredit_motor->spv_kredit_motor_id) ==  $spv_kredit_motor->id ? 'selected=""' : ""); ?> value="<?php echo e($spv_kredit_motor->id); ?>"><?php echo e($spv_kredit_motor->name); ?></option>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/cs_kredit_motor/pengajuan_kredit_motor.blade.php */ ?>