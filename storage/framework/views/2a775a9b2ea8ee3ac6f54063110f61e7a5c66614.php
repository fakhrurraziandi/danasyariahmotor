    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '<?php echo e(route('manager_pembiayaan_dana.json_pengajuan_pembiayaan_dana')); ?>',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
                    ...
                    {
                        field: 'manager_pembiayaan_dana_status',
                        title: 'SPV Status',
                    },
                    {
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/manager_pembiayaan_dana/list_pengajuan_pembiayaan_dana.blade.php */ ?>