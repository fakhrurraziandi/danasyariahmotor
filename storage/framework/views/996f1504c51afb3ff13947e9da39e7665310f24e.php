    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="mb-3"><a href="<?php echo e(route('admin.pengajuan_kredit_motor.index')); ?>" class="btn btn-secondary">Back</a></p>
                        <div class="card mb-3">
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/admin/pengajuan_kredit_motor/show.blade.php */ ?>