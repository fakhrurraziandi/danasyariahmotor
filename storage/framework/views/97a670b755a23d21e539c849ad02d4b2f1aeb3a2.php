        ...
        <div class="container">
            ...
            <form method="POST" action="<?php echo e(route('submit-akad-kredit')); ?>">
                ...
                <div class="row">
					...
					<div class="col-md-3 mb-4">
                        <div class="form-group">
                            <label for="nilai_cair">Nilai Cair Bersih diterima</label>
                            <input name="nilai_cair" id="nilai_cair" class="form-control" />
                        </div>    
                    </div>
					<div class="col-md-3 mb-4">
                        <div class="form-group">
                            <label for="nilai_angsuran">Angsuran Tiap Bulan</label>
                            <input name="nilai_angsuran" id="nilai_angsuran" class="form-control" />
                        </div>    
                    </div>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/akad-kredit.blade.php */ ?>