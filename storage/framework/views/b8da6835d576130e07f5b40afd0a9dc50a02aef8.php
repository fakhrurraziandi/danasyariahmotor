    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">Add new warna motor</div>
                    <div class="card-body">

                        <form action="<?php echo e(route('backend.warna_motor.store')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/backend/warna_motor/create.blade.php */ ?>