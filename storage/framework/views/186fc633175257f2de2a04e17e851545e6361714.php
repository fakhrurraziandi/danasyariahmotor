            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.motor_pembiayaan_dana.update', $motor_pembiayaan_dana->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" name="name" id="name" value="<?php echo e(old('name', $motor_pembiayaan_dana->name)); ?>">
                                ...
                                <div class="col-sm-10">
                                    <select name="pabrikan_motor_id" id="pabrikan_motor_id" class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>">
                                        ...
                                        <?php $__currentLoopData = $list_pabrikan_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pabrikan_motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($pabrikan_motor->id == old('pabrikan_motor_id', $motor_pembiayaan_dana->pabrikan_motor_id) ? 'selected=""' : ''); ?> value="<?php echo e($pabrikan_motor->id); ?>"><?php echo e($pabrikan_motor->name); ?></option>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/motor_pembiayaan_dana/edit.blade.php */ ?>