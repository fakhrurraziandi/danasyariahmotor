                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.motor.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jenis_pembakaran_id" id="jenis_pembakaran_id" class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>">
                                        <option value=""></option>
                                        <?php $__currentLoopData = $list_jenis_pembakaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis_pembakaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($jenis_pembakaran->id == old('jenis_pembakaran_id') ? 'selected=""' : ''); ?> value="<?php echo e($jenis_pembakaran->id); ?>"><?php echo e($jenis_pembakaran->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="fitur" id="fitur" cols="30" rows="10" class="form-control  <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"><?php echo e(old('fitur')); ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?php echo e($errors->has('harga') ? 'is-invalid' : ''); ?>" name="harga" id="harga" value="<?php echo e(old('harga')); ?>">
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/admin/motor/create.blade.php */ ?>