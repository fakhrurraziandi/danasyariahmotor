                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?php echo e($errors->has('type') ? 'is-invalid' : ''); ?>" id="type" name="type">
                                            <option <?php echo e(old('type') == 'pembiayaan_dana' ? 'selected=""' : ''); ?> value="pembiayaan_dana">Pembiayaan Dana</option>
                                            <option <?php echo e(old('type') == 'kredit_motor' ? 'selected=""' : ''); ?> value="kredit_motor">Kredit Motor</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?php echo e($errors->has('wilayah_kredit_motor_id') ? 'is-invalid' : ''); ?>" id="wilayah_kredit_motor_id" name="wilayah_kredit_motor_id">
                                            ...
                                            <?php $__currentLoopData = App\WilayahKreditMotor::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wilayah_kredit_motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('wilayah_kredit_motor_id') == $wilayah_kredit_motor->id ? 'selected=""' : ''); ?> value="<?php echo e($wilayah_kredit_motor->id); ?>"><?php echo e($wilayah_kredit_motor->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/testimoni_gallery/create.blade.php */ ?>