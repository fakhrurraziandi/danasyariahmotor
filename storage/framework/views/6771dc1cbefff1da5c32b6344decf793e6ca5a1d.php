            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.testimoni_motor.update', $testimoni_motor->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" type="text" clas="form-control" name="name" id="name" value="<?php echo e(old('name', $testimoni_motor->name)); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control <?php echo e($errors->has('message') ? 'is-invalid' : ''); ?>" name="message" id="message" cols="30" rows="10"><?php echo e(old('message', $testimoni_motor->message)); ?></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate1" name="rate" class="custom-control-input" value="1" <?php echo e(old('rate', $testimoni_motor->rate) == 1 ? 'checked=""' : ''); ?>>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate2" name="rate" class="custom-control-input" value="2" <?php echo e(old('rate', $testimoni_motor->rate) == 2 ? 'checked=""' : ''); ?>>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate3" name="rate" class="custom-control-input" value="3" <?php echo e(old('rate', $testimoni_motor->rate) == 3 ? 'checked=""' : ''); ?>>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate4" name="rate" class="custom-control-input" value="4" <?php echo e(old('rate', $testimoni_motor->rate) == 4 ? 'checked=""' : ''); ?>>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate5" name="rate" class="custom-control-input" value="5" <?php echo e(old('rate', $testimoni_motor->rate) == 5 ? 'checked=""' : ''); ?>>
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/testimoni_motor/edit.blade.php */ ?>