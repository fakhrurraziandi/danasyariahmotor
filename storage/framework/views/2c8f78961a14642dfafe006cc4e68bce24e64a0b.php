<?php $__env->startSection('sub_content'); ?>
    ...
    <form action="<?php echo e(route('manager_pembiayaan_dana.update_password', [$manager_pembiayaan_dana->id])); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-9 offset-sm-3">
                <a href="<?php echo e(route('manager_pembiayaan_dana.index')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php /* /home/fakhrurraziandi/Code/dsm/resources/views/manager_pembiayaan_dana/change_password.blade.php */ ?>