				...
				<div class="row">
					...
					<?php $__empty_1 = true; $__currentLoopData = $list_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
						<div class="col-md-4 mb-3">
							...
							<a href="<?php echo e(route('detail-motor', $motor->slug)); ?>" class="card border-0 shadow-sm d-flex justify-content-between text-dark" style="height: 100%;">
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/beli-motor.blade.php */ ?>