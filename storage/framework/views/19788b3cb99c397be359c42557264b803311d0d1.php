                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="table-data-toolbar">
                            ...
                            <a href="<?php echo e(route('admin.angsuran_motor.create', $motor->id)); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
                        </div>
    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '<?php echo e(route('admin.angsuran_motor.json', $motor->id)); ?>',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/admin/angsuran_motor/index.blade.php */ ?>