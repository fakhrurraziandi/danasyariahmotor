            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.angsuran_motor.store', $motor->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control <?php echo e($errors->has('dp') ? 'is-invalid' : ''); ?>" name="dp" id="dp">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" max="100" min="0" class="form-control <?php echo e($errors->has('discount_dp') ? 'is-invalid' : ''); ?>" name="discount_dp" id="discount_dp" value="<?php echo e(old('discount_dp')); ?>">
                            ...
                            <?php $__currentLoopData = $list_tempo_angsuran_motor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tempo_angsuran_motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                    <input type="text" class="form-control tempo_angsuran_motor_id <?php echo e($errors->has('tempo_angsuran_motor_id') ? 'is-invalid' : ''); ?>" name="tempo_angsuran_motor_id[<?php echo e($tempo_angsuran_motor->id); ?>]" id="tempo_angsuran_motor_id">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 offset-sm-2">
                                    ...
                                    <a href="<?php echo e(route('admin.angsuran_motor.index', $motor->id)); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
...
<?php /* /home/fakhrurraziandi/Code/danasyariahmotor.com/resources/views/admin/angsuran_motor/create.blade.php */ ?>