                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="table-data-toolbar">
                            <a href="<?php echo e(route('admin.cs_kredit_motor.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
                        </div>
    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '<?php echo e(route('admin.cs_kredit_motor.json')); ?>',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
...
<?php /* /home/danasyariahmotor/public_html/resources/views/admin/cs_kredit_motor/index.blade.php */ ?>