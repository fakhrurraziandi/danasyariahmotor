    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '<?php echo e(route('cs_kredit_motor.json_pengajuan_kredit_motor')); ?>',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
                        ...
                        formatter: function(value, row, index){
                            return `
                                <a class="btn btn-sm btn-info" href="${ base_url + '/cs_kredit_motor/pengajuan_kredit_motor/' + value }">Detail</a>
                            `;
                        }
                    },
                    {
...

                    {
                        ...
                        title: 'Discount DP',
                        formatter: function(angsuran_motor, row, index){
                            return angsuran_motor.discount_dp ? angsuran_motor.discount_dp + '%' : '-';
                        }
                    },

                    {
                        ...
                        title: 'DP Bayar',
                        formatter: function(angsuran_motor, row, index){
                            return 'Rp. ' + number_format(angsuran_motor.dp_calculated, 0, ',', '.');
                        }
                    },
...
<?php /* /home/danasyariahmotor/public_html/resources/views/cs_kredit_motor/list_pengajuan_kredit_motor.blade.php */ ?>