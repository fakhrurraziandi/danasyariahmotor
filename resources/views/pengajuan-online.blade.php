...
@section('content')
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                    <img data-src="{{asset('dsm_design/dist/img/vespa-only@2x.png')}}" class="lazy img-fluid" alt="Dana Syariah Motor">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 mb-4 text-center">
                    <img data-src="{{asset('dsm_design/dist/img/vespa-circle@2x.png')}}" class="lazy img-fluid" alt="Dana Syariah Motor">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <img data-src="{{asset('dsm_design/dist/img/persyaratan-umum-1-200x200.png')}}" class="lazy img-fluid mb-3" alt="Dana Syariah Motor">
                            <h3 class="h5">Usia 21-60 tahun dan atau sudah berkeluarga</h3>
                        </div>
                        <div class="col text-center">
                            <img data-src="{{asset('dsm_design/dist/img/persyaratan-umum-2-200x200.png')}}" class="lazy img-fluid mb-3" alt="Dana Syariah Motor">
                            <h3 class="h5">Fotokopi Kartu Keluarga atau Akte Nikah</h3>
                        </div>
                        <div class="col text-center">
                            <img data-src="{{asset('dsm_design/dist/img/persyaratan-umum-3-200x200.png')}}" class="lazy img-fluid mb-3" alt="Dana Syariah Motor">
                            <h3 class="h5">Fotokopi PBB 2 tahun terakhir atau rekening listrik 6 bulan terakhir</h3>
                        </div>
                        <div class="col text-center">
                            <img data-src="{{asset('dsm_design/dist/img/persyaratan-umum-4-200x200.png')}}" class="lazy img-fluid mb-3" alt="Dana Syariah Motor">
    ...
    <section class="py-100" id="section-form">
        <div class="container">
            ...
            <form action="{{route('submit-pengajuan-online')}}#section-form" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="form-group">
                            ...
                            <select name="wilayah_kredit_motor_id" id="wilayah_kredit_motor_id" class="form-control custom-form-control {{$errors->has('wilayah_kredit_motor_id') ? 'is-invalid' : ''}}">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="form-group">
                            ...
                            <select name="motor_id" id="motor_id" class="form-control custom-form-control {{$errors->has('motor_id') ? 'is-invalid' : ''}}">
                                <option value="">:: Pilih Motor ::</option>
                                @foreach($list_motor as $motor)
                                    <option {{old('motor_id') == $motor->id ? 'selected=""' : ''}} data-json_angsuran_motor="{{$motor->angsuran_motor->toJson()}}" value="{{$motor->id}}">{{$motor->name}}</option>
                                @endforeach
                            </select>
                            @if($errors->has('motor_id'))
                                <div class="invalid-feedback">
                                    {{$errors->first('motor_id')}}
                                </div>
                            @endif
                        </div>    
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="form-group">
                            ...
                            <select name="angsuran_motor_id" id="angsuran_motor_id" class="form-control custom-form-control {{$errors->has('angsuran_motor_id') ? 'is-invalid' : ''}}">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="form-group">
                            ...
                            <select name="angsuran_motor_detail_id" id="angsuran_motor_detail_id" class="form-control custom-form-control {{$errors->has('angsuran_motor_detail_id') ? 'is-invalid' : ''}}">
