    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="">
                ...
                <h1 class="text-center font-weight-light">{{ isset($url) ? ucwords($url) : ""}} Form Pendaftaran Konsumen</h1>
				<hr>
                <br>
                @isset($url)
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" name="name" placeholder="Nama Lengkap" value="{{ old('name') }}" autofocus>
                                @if ($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select rows="3" class="form-control {{ $errors->has('sumber_informasi') ? ' is-invalid' : '' }}" id="sumber_informasi" name="sumber_informasi" placeholder="Isi Alamat Anda Dengan Lengkap">
                                    <?php  
                                    ...
                                    @foreach($list_sumber_informasi as $sumber_informasi)
                                        <option {{old('sumber_informasi') == $sumber_informasi ? 'selected=""' : ''}} value="{{$sumber_informasi}}">{{$sumber_informasi}}</option>
                                    @endforeach
                                    </select>
                                @if ($errors->has('sumber_informasi'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('sumber_informasi') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="ref_code">Kode Referal (Silakan Kontak WA CS bila tidak mengetahui)</label>
                                <input type="text" class="form-control {{ $errors->has('ref_code') ? ' is-invalid' : '' }}" id="ref_code" name="ref_code" placeholder="Kode Referal" value="{{old('ref_code')}}">
