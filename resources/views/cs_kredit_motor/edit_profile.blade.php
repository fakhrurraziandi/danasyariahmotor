...
@section('sub_content')
    ...
    <form action="{{route('cs_kredit_motor.update_profile', [$cs_kredit_motor->id])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-9">
                <input type="email" class="form-control" id="email" name="email" value="{{old('email', $cs_kredit_motor->email)}}">
            </div>
        </div>
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="name" name="name" value="{{old('name', $cs_kredit_motor->name)}}">
            </div>
        </div>
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{old('phone_number', $cs_kredit_motor->phone_number)}}">
            </div>
        </div>
