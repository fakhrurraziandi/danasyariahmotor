    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">Change {{$spv_kredit_motor->name}} password</div>
                    <div class="card-body">

                        <form action="{{route('admin.spv_kredit_motor.update_password', $spv_kredit_motor->id)}}" method="POST">
