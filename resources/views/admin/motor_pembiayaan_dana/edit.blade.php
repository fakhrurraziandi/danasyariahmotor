            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.motor_pembiayaan_dana.update', $motor_pembiayaan_dana->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" name="name" id="name" value="{{old('name', $motor_pembiayaan_dana->name)}}">
                                    @if($errors->has('name'))
                                ...
                                <div class="col-sm-10">
                                    <select name="pabrikan_motor_id" id="pabrikan_motor_id" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}">
                                        ...
                                        @foreach($list_pabrikan_motor as $pabrikan_motor)
                                            <option {{$pabrikan_motor->id == old('pabrikan_motor_id', $motor_pembiayaan_dana->pabrikan_motor_id) ? 'selected=""' : ''}} value="{{$pabrikan_motor->id}}">{{$pabrikan_motor->name}}</option>
                                        @endforeach
                                    </select>
