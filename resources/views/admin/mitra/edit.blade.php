                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{$errors->has('no_handphone_1') ? 'is-invalid' : ''}}" id="no_handphone_1" name="no_handphone_1" placeholder="No Handphone 1" value="{{old('no_handphone_1', $user->no_handphone_1)}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control {{$errors->has('tanggal_lahir') ? 'is-invalid' : ''}}" id="tanggal_lahir" name="tanggal_lahir" placeholder="Tempat Lahir" value="{{old('tanggal_lahir', $user->tanggal_lahir)}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control {{ $errors->has('province_id') ? ' is-invalid' : '' }}" id="province_id" name="province_id" placeholder="Provinsi">
                                            ...
                                            @foreach(Province::with(['cities'])->get() as $province)
                                                <option {{old('province_id', $user->city ? $user->city->province->id : null) == $province->id ? 'selected=""' : ''}} data-json="{{$province->toJson()}}" value="{{$province->id}}">{{$province->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control {{ $errors->has('city_id') ? ' is-invalid' : '' }}" id="city_id" name="city_id" placeholder="Kota">
                                            ...
                                            @if($user->city)
                                                @foreach($user->city->province->cities as $city)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{$errors->has('alamat') ? 'is-invalid' : ''}}" id="alamat" name="alamat" placeholder="Alamat">{{old('alamat', $user->alamat)}}</textarea>
