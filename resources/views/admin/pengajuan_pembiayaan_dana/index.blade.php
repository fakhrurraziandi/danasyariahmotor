...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="table-data-toolbar">
                            {{-- <a href="{{route('admin.pengajuan_pembiayaan_dana.export_pdf')}}" class="btn btn-danger"><i class="fa fa-file-pdf"></i> Export as PDF</a> --}}
    ...
    <div class="modal fade export-pdf-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form class="modal-content" method="GET" target="_blank" action="{{route('admin.pengajuan_pembiayaan_dana.export_pdf')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-group--mitra" style="display: block;">
                        <label for="mitra_id">Filter by Mitra</label>
                        <select name="mitra_id" id="mitra_id" class="form-control">
                            <option value=""></option>
                            @foreach(App\User::where('mitra_status', 2)->orderBy('name', 'ASC')->get() as $user)
                    ...
                    <div class="form-check">
                        <input type="checkbox" value="1" class="form-check-input" name="go_live_only" id="go_live_only">
                        <label class="form-check-label" for="go_live_only">Go live only</label>
                    </div>
    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '{{route('admin.pengajuan_pembiayaan_dana.json')}}',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
                    ...
                    },
                    {
                        ...
                        formatter: function(cs_pembiayaan_dana_status){
                            if(cs_pembiayaan_dana_status == 'approved'){
                                return '<i class="fa fa-check"></i>';
                            }

                            if(cs_pembiayaan_dana_status == 'denied'){
                    ...
                    },
                    {
                        ...
                        formatter: function(spv_pembiayaan_dana_status){
                            if(spv_pembiayaan_dana_status == 'approved'){
                                return '<i class="fa fa-check"></i>';
                            }

                            if(spv_pembiayaan_dana_status == 'denied'){
                                return '<i class="fa fa-times"></i>';
                            }
                        }
                    },
