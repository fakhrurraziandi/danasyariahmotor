            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.angsuran_motor.update', $angsuran_motor->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control {{$errors->has('dp') ? 'is-invalid' : ''}}" name="dp" id="dp" value="{{old('dp', $angsuran_motor->dp)}}">
                                    @if($errors->has('dp'))
                                ...
                                <div class="col-sm-3">
                                    <input type="text" max="100" min="0" class="form-control {{$errors->has('discount_dp') ? 'is-invalid' : ''}}" name="discount_dp" id="discount_dp" value="{{old('discount_dp', $angsuran_motor->discount_dp)}}">
                            ...
                            @foreach($list_tempo_angsuran_motor as $tempo_angsuran_motor)
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control tempo_angsuran_motor_id {{$errors->has('tempo_angsuran_motor_id') ? 'is-invalid' : ''}}" name="tempo_angsuran_motor_id[{{$tempo_angsuran_motor->id}}]" id="tempo_angsuran_motor_id" value="<?php  
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 offset-sm-2">
                                    ...
                                    <a href="{{route('admin.angsuran_motor.index', $angsuran_motor->motor->id)}}" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
