            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.spesifikasi_motor.store', $motor->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control {{$errors->has('kategori_spesifikasi_id') ? 'is-invalid' : ''}}" name="kategori_spesifikasi_id" id="kategori_spesifikasi_id">
                                        ...
                                        @foreach($list_kategori_spesifikasi as $kategori_spesifikasi)
                                            <option {{old('kategori_spesifikasi_id') == $kategori_spesifikasi->id ? 'selected=""' : ''}} value="{{$kategori_spesifikasi->id}}">{{$kategori_spesifikasi->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control {{$errors->has('value') ? 'is-invalid' : ''}}" type="text" name="value" id="value" rows="10">{{old('value')}}</textarea>
                                    @if($errors->has('value'))
                                        <div class="invalid-feedback">
                                            {{$errors->first('value')}}
                                        </div>
