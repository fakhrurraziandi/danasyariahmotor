    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">Report Withdraw</div>
                    <div class="card-body">

                        <form action="{{route('admin.request_withdraw.report_pdf')}}" method="GET">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-10 offset-sm-2">
                                    ...
                                    <a href="{{route('admin.request_withdraw.index')}}" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
