                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="table-data-toolbar">
                            <a href="{{route('admin.tempo_angsuran_pembiayaan_dana.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
                        </div>
    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '{{route('admin.tempo_angsuran_pembiayaan_dana.json')}}',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
