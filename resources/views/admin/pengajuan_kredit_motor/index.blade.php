...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="table-data-toolbar">
                            {{-- <a href="{{route('admin.pengajuan_kredit_motor.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a> --}}
    ...
    <div class="modal fade export-pdf-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form class="modal-content" method="GET" target="_blank" action="{{route('admin.pengajuan_kredit_motor.export_pdf')}}">
    ...
    <script>
        $(function(){
            ...
            $('#table-data').bootstrapTable({
                ...
                url: '{{route('admin.pengajuan_kredit_motor.json')}}',
                columns: [
                    {
                        field: 'id',
                        title: 'Action',
