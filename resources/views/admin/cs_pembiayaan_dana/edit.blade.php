            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.cs_pembiayaan_dana.update', $cs_pembiayaan_dana->id)}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" id="name" name="name" placeholder="Name" value="{{old('name', $cs_pembiayaan_dana->name)}}">
                                        @if($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control {{$errors->has('email') ? 'is-invalid' : ''}}" id="email" name="email" placeholder="Email" value="{{old('email', $cs_pembiayaan_dana->email)}}">
                                        @if($errors->has('email'))
                                            <div class="invalid-feedback">
                                                {{$errors->first('email')}}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{$errors->has('phone_number') ? 'is-invalid' : ''}}" id="phone_number" name="phone_number" placeholder="Phone Number" value="{{old('phone_number', $cs_pembiayaan_dana->phone_number)}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control {{$errors->has('wilayah_pembiayaan_dana_ids') ? 'is-invalid' : ''}}" id="wilayah_pembiayaan_dana_ids" name="wilayah_pembiayaan_dana_ids[]" placeholder="Wilayah" multiple="">
                                            @foreach($list_wilayah_pembiayaan_dana as $wilayah_pembiayaan_dana)
                                                <option {{in_array($wilayah_pembiayaan_dana->id, old('wilayah_pembiayaan_dana_ids', $cs_pembiayaan_dana->wilayah_pembiayaan_dana_ids)) ? 'selected=""' : ''}} value="{{$wilayah_pembiayaan_dana->id}}">{{$wilayah_pembiayaan_dana->name}}</option>
                                            @endforeach
                                        </select>
