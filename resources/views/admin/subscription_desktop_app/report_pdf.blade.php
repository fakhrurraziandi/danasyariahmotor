...
<table style="width: 100%" border="1" cellspacing="0" cellpadding="5">
    ...
    <tbody>
        @foreach ($subscription_desktop_apps as $subscription_desktop_app)
            <?php  
            ...
            <tr>
                ...
                <th>{{$subscription_desktop_app->id}}</th>
                ...
                <th>{{$subscription_desktop_app->status}}</th>
                <th>{{$subscription_desktop_app->subscription_duration}}</th>
                <th>{{'Rp. '. number_format($subscription_desktop_app->price, 0, ',', '.')}}</th>
                <th>{{$subscription_desktop_app->description}}</th>
                
                <th>{{$subscription_desktop_app->created_at}}</th>
                <th>{{$subscription_desktop_app->updated_at}}</th>
