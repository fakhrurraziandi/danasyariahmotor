    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">Change {{$manager_pembiayaan_dana->name}} password</div>
                    <div class="card-body">

                        <form action="{{route('admin.manager_pembiayaan_dana.update_password', $manager_pembiayaan_dana->id)}}" method="POST">
