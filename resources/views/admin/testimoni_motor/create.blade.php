            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.testimoni_motor.store', $motor->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" type="text" clas="form-control" name="name" id="name" value="{{old('name')}}">
                                    @if($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control {{$errors->has('message') ? 'is-invalid' : ''}}" name="message" id="message" cols="30" rows="10">{{old('message')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate1" name="rate" class="custom-control-input" value="1" {{old('rate') == 1 ? 'checked=""' : ''}}>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate2" name="rate" class="custom-control-input" value="2" {{old('rate') == 2 ? 'checked=""' : ''}}>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate3" name="rate" class="custom-control-input" value="3" {{old('rate') == 3 ? 'checked=""' : ''}}>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate4" name="rate" class="custom-control-input" value="4" {{old('rate') == 4 ? 'checked=""' : ''}}>
                                    ...
                                    <br>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="rate5" name="rate" class="custom-control-input" value="5" {{old('rate') == 5 ? 'checked=""' : ''}}>
