...
@section('sub_content')
    ...
    <form action="{{route('spv_kredit_motor.process_pengajuan_kredit_motor', $pengajuan_kredit_motor->id)}}" method="POST">
        ...
        <div class="row">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8">{{$pengajuan_kredit_motor->cs_kredit_motor->name}}</dd>

                            <dt class="col-sm-4">Email</dt>
                            <dd class="col-sm-8">{{$pengajuan_kredit_motor->cs_kredit_motor->email}}</dd>
                            
                            <dt class="col-sm-4">Phone Number</dt>
                            <dd class="col-sm-8">{{$pengajuan_kredit_motor->cs_kredit_motor->phone_number}}</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            @if(!$pengajuan_kredit_motor->spv_kredit_motor_status)
