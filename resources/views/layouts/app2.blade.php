...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link rel="stylesheet" href="{{asset('dsm_design/dist/css/main-2.css')}}">
		...
		'https://connect.facebook.net/en_US/fbevents.js');
		 fbq('init', '830872513961127'); 
		fbq('track', 'PageView');
		</script>
		<noscript>
		 <img height="1" width="1" 
		src="https://www.facebook.com/tr?id=830872513961127&ev=PageView
		&noscript=1"/>
		</noscript>
	...
	<script>
        ...
        <div class="">
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link text-success" href="{{route('home')}}">
                                        <strong><i class="fa fa-arrow-left"></i> Kembali Ke Halaman Utama</strong> 
                                    </a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="bg-gradient__lush py-5">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-md-2 text-center">
                            <a href="{{route('beli-motor')}}"><img data-src="{{asset('img/spm_logo.png')}}" class="lazy img-fluid mb-5" alt="Dana Syariah Motor" style="width: 70% !important;"></a>  
                        </div>
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <nav class="navbar navbar-expand-lg px-md-0">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <form class="form-inline my-2 my-lg-0">
                                                ...
                                                <a href="#" class="btn btn-warning my-2 my-sm-0 mr-1">Kontak Kami</a>
        ...
        <footer class="py-50 bg-success text-white">
            <div class="container">
                <div class="row d-flex">
                    ...
                    @if(request()->header('User-Agent') !== 'Mobile-App')
        ...
        <script src="//code.jivosite.com/widget.js" jv-id="ME331x3FuO" async></script>--}}
        ...
        <div class="wcs_popup">
            ...
            <div class="wcs_popup_header_description">Butuh Bantuan? Chat whatsapp staf kami</div>
			  ...
			  <div class="wcs_popup_person_container">
                    <div class="wcs_popup_person" data-number="6281915840231">
                        <div class="wcs_popup_person_img">
                            <img src="{{ asset('plugin/img/Rhisma.jpg')}}" alt="Dana Syariah Motor">
                        </div>
                        <div class="wcs_popup_person_content">
                            <div class="wcs_popup_person_name">RHISMA DSM</div>
                            <div class="wcs_popup_person_description">SUPPORT DSM</div>
    ...
    <script>
     ...
     $(".wcs_popup_person").click(function(){
       ...
       location.href='https://wa.me/'+number+'?text=*Assalamualaikum*%20*Wr*%20*Wb*%20%0ANama%20Saya%20:%20.....%20%0ASaya%20Mau%20bertanya%20: .....%0A(Kami%20Bukan%20Pinjaman%20Online%20Tanpa%20Jaminan)';
     });
    </script>
    @yield('scripts')
</html>