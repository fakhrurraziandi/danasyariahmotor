...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('codeseven-toastr/build/toastr.min.css')}}">
                        ...
                        @elseif(Auth::check())
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @else
                                        <a class="dropdown-item" href="{{route('pengajuan_pembiayaan_dana_mitra.index')}}">
                                            {{ __('Daftar Customer Mitra') }}
                                        </a>
                                    @endif
